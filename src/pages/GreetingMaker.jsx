...
const SHARE_TEXTS = {
  YOM_RISHON: [
    ...
    'יום ראשון בפתח, שיהיה לכולנו שבוע רגוע ומלא השראה.',
  ...
  YOM_SHENI: [
    ...
    'שיהיה לכם יום שני מלא בשלווה והצלחה.',
  ...
  YOM_SHLISHI: [
    ...
    'פעמיים כי טוב – שיהיה לכולכם יום מוצלח ומלא שפע.',
  ...
  YOM_RVII: [
    ...
    'יום רביעי בפתח, שיהיה לכם יום רגוע ומספק.',
  ...
  YOM_CHAMISHI: [
    ...
    'שיהיה לכם יום חמישי מלא באופטימיות ואנרגיות של סופ"ש.',
  ...
  SHABAT: [
    ...
    'שתהיה לכולנו שבת שלום, של אוכל טוב וזמן איכות.',
    ...
    'שתהיה לכם שבת רגועה ומלאה בכל טוב.',
  ...
  SHAVUA_TOV: [
    ...
    'שיהיה לכולנו שבוע נפלא, מלא בעשייה ברוכה.',
  ...
  MAZAL_TOV: [
    ...
    'מזל טוב! יום מיוחד ומאושר, מגיע לך הכל.',
  ],
  BEHATZLACHA: [
    'בהצלחה רבה בכל דרך חדשה שמחכה לך!',
    'המון הצלחה בדרך החדשה!',
    'בהצלחה! אין לי ספק שמחכים לך הישגים גדולים.',
    'בהצלחה רבה! עם אמונה בעצמך אפשר להגיע להכל.',
    'המון הצלחה! שהדרך והיעד יהיו מלאי סיפוק והנאה.',
    'בהצלחה! שהברכה תלווה כל מעשה ומעשה.',
    'בהצלחה רבה! עם ביטחון בעצמך הכל אפשרי.',
    'המון בהצלחה, השמיים הם הגבול!',
    'בהצלחה! מחזיקים לך אצבעות בכל צעד.',
    'בהצלחה רבה! תמיד אפשר לסמוך עליי.',
  ],
}
...
const SHARE_GENERIC = [
  ...
  'שיהיה לך רק טוב — ברכה ממני אליך 💛',
...
function pickShareText(ctx = {}) {
  ...
  let base = null
  if (key && SHARE_TEXTS[key]) base = shareRandomFrom(SHARE_TEXTS[key])
  if (!base) {
    const t = text || ''
    for (const entry of SHARE_KEYWORDS) {
      if (entry.kws.some(kw => t.includes(kw)) && SHARE_TEXTS[entry.id]) {
        base = shareRandomFrom(SHARE_TEXTS[entry.id])
        break
      }
    }
  }
  if (!base) base = shareRandomFrom(SHARE_GENERIC)
  return base + SHARE_PROMO
}
