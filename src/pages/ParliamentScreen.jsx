...
import {
  leaveParliamentRoom as leaveParliamentSession,
  updateParliamentRoomState as updateParliamentState,
  watchParliamentRoom as watchParliamentSession,
...
const TOPICS = [
  'אם הייתם יכולים לחזור ליום אחד מהעבר — לאיזה יום הייתם בוחרים?',
  'מה העצה הכי טובה שקיבלתם בחיים, וממי?',
  'איזה שיר מחזיר אתכם מיד אחורה בזמן — ולאן?',
  'איזה תחביב תמיד רציתם לנסות ולא יצא לכם?',
  'מה הייתם אומרים לעצמכם בני העשרים, אם הייתם יכולים?',
  'איזו ארוחה טעמה לכם הכי טוב בחיים — ומי הכין אותה?',
  'אם היתה לכם דקה מול כל המדינה, מה הייתם אומרים?',
  'מה דווקא היה טוב יותר פעם — ומה השתפר היום?',
  'איזה מקום בעולם או בארץ הכי ריגש אתכם?',
  'מי האדם שהכי עיצב את מי שאתם היום?',
  'אם הייתם פותחים עסק קטן משלכם היום — מה הוא היה?',
  'מה הייתם רוצים שהצעירים היום ידעו?',
  'מה היה הריח של הבית שגדלתם בו?',
  'איזה משחק ילדות שיחקתם ברחוב — ואיך הוא עבד?',
  'מי היה הסבא או הסבתא שלכם, ומה הכי זכור לכם ממנו?',
  'מה הדבר הראשון שקניתם מכסף שהרווחתם בעצמכם?',
  'איזו מנה הכי מזכירה לכם בית?',
  'מה הייתה ההרפתקה הכי גדולה שעשיתם בחיים?',
  'אם הייתם יכולים לשבת לקפה עם דמות אחת מההיסטוריה — עם מי?',
  'איזה סרט או הצגה שינו לכם משהו בראש?',
  'מה הדבר הקטן שגורם לכם לחייך כל בוקר?',
  'איזו מילה או ביטוי השתמשו בהם פעם, והיום כבר לא שומעים?',
  'מה הייתה העבודה הראשונה שלכם, ומה למדתם ממנה?',
  'איזה חפץ בבית מלווה אתכם הכי הרבה שנים?',
  'אם הייתם צריכים ללמד שיעור אחד לכולם — על מה הוא היה?',
  'מה הדבר שתמיד הצחיק אתכם, גם כשלא היה צריך?',
  'איזו חתונה או חגיגה זכורה לכם במיוחד, ולמה?',
  'מה הטיול הכי יפה שעשיתם בארץ?',
  'איזה שיר הייתם שרים בקול בלי להתבייש?',
  'מי לימד אתכם משהו שאתם עדיין משתמשים בו היום?',
  'מה הדבר שהכי השתנה בשכונה שגדלתם בה?',
  'אם היו נותנים לכם יום חופש בלי שום מחויבות — מה הייתם עושים?',
  'איזה חפץ קטן לא הייתם מוכנים לזרוק בשום אופן?',
  'מה הייתה ההפתעה הכי יפה שקיבלתם?',
  'איזו יכולת או כישור הייתם רוצים שתהיה לכם?',
  'מה הדבר שאנשים מתפלאים לגלות עליכם?',
  'איזו עונה בשנה הכי מדברת אליכם — ולמה?',
  'מה הייתם לוקחים איתכם לאי בודד (חוץ מאנשים)?',
  'מי היה החבר הכי טוב שלכם בגיל צעיר, ומה עשיתם יחד?',
  'מה הדבר שעשיתם בחיים ואתם הכי גאים בו?',
  'אם הבית שלכם היה יכול לדבר — מה הוא היה מספר?',
  'איזה מאכל ניסיתם פעם אחת ולעולם לא שוב?',
  'מה הייתה האופנה שאהבתם פעם — ומצחיקה אתכם היום?',
  'איזה מקצוע אחר הייתם בוחרים אם הייתם מתחילים מהתחלה?',
  'איזה ספר או סיפור קראתם שוב ושוב ולא נמאס?',
]
