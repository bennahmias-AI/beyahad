/*
  MonopolyBoard.jsx
  Renders Ben's ORIGINAL restored vintage board (1:1 art via monopolyBoardArt)
...
import { TILES } from '../data/monopolyBoard';
import { buildBoardHTML, BOARD_CSS } from '../data/monopolyBoardArt';
...
// ---- main component -----------------------------------------------------------
export default function MonopolyBoard({ focusTiles = null, tokens = [], owners = {}, hotels = {}, tokenColors = {}, priceIndex = null }) {
  ...
  return (
    <div ref={wrapRef} style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div className="mono-stage" dangerouslySetInnerHTML={{ __html: boardHTML }} />
