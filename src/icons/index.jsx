...
// צ'אט/הודעות — בועת דיבור (קו פשוט)
export const IconChatLine = (p) => (
  <LineIcon {...p}>
    <path d="M21 11.5a8.38 8.38 0 0 1-9 8.4 9 9 0 0 1-3.6-.7L3 21l1.8-5.4A8.38 8.38 0 0 1 4 11.5a8.5 8.5 0 0 1 17 0Z" />
  </LineIcon>
)

// משחק — בקר משחק (קו פשוט)
